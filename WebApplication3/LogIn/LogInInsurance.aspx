<%@ Page Title="" Language="C#" MasterPageFile="~/LogIn/LogInWebMaster.Master" AutoEventWireup="true" CodeBehind="LogInInsurance.aspx.cs" Inherits="WebApplication3.LogIn.LogInInsurance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label3" runat="server" BackColor="#FF33CC" CssClass="auto-style12" ForeColor="White" Text="Insurance Log IN"></asp:Label>
        </td>
    </tr>
    <tr>
