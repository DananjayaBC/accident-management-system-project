...
namespace WebApplication3.LogIn
{
    public partial class LogInPolice : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string qry = "SELECT * FROM Police WHERE Id='" + Id + "' AND Password='" + Password + "'";
            ...
            try
            {
                ...
                if (sdr.Read())
                {
                    ...
                    Response.Redirect("~/Police/PoliceReport.aspx");
                    TextBox1.Text = null;
                    TextBox2.Text = null;
                }
                else
