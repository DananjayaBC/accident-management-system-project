<%@ Page Title="" Language="C#" MasterPageFile="~/LogIn/LogInWebMaster.Master" AutoEventWireup="true" CodeBehind="LogInPolice.aspx.cs" Inherits="WebApplication3.LogIn.LogInPolice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label3" runat="server" BackColor="Red" CssClass="auto-style12" ForeColor="White" Text="Police Log IN"></asp:Label>
        </td>
    </tr>
    <tr>
